...
class ProductLocalDatasource {
  ...
  Future<void> _createDB(Database db, int version) async {
    await db.execute(
      'CREATE TABLE $tableProducts (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, price INTEGER, stock INTEGER, image TEXT, category TEXT)',
    );
  }
  ...
  // insert data product from list products;
